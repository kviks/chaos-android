...
class FreeplayState extends MusicBeatState
{
	...
	override function create() {
		...
		songs.push(new TrickyButton(80,360,'menu/freeplay/Improbable Outset Button','menu/freeplay/Improbable Outset Confirm',selectSong, 'improbable-chaos', -30));
	...
	override function update(elapsed:Float)
	{
		...
		if (MusicMenu.Vocals != null)
		{
			...
			var score = Highscore.getScore(songs[selectedIndex].pognt,diff);
			if (songs[selectedIndex].pognt == 'improbable-chaos')
